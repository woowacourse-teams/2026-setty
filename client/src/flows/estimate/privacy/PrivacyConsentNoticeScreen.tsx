...
import { ESTIMATE_PRIVACY_CONSENT_NOTICE } from './privacyConsentNotice';
    ...
    >
      <div className={styles.content}>
        <h2 className={styles.title}>
          {ESTIMATE_PRIVACY_CONSENT_NOTICE.title.map((line) => (
        ...
        <dl className={styles.sections}>
          {ESTIMATE_PRIVACY_CONSENT_NOTICE.sections.map((section) => (
